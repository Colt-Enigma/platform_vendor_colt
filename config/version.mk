...
COLT_MAJOR_VERSION = 12L
COLT_RELEASE_VERSION = v8.1
...
COLT_VERSION := ColtOS-$(COLT_MAJOR_VERSION)-$(COLT_BUILD_VERSION)-$(COLT_BUILD)-$(COLT_BUILD_TYPE)-$(COLT_BUILD_VARIANT)-$(COLT_BUILD_DATE)
