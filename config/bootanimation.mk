...
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1080x2246)
     PRODUCT_COPY_FILES += vendor/colt/prebuilt/common/media/1080x2246.zip:system/media/bootanimation.zip
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1080x2248)
     PRODUCT_COPY_FILES += vendor/colt/prebuilt/common/media/1080x2248.zip:system/media/bootanimation.zip
...
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1080x2340)
     PRODUCT_COPY_FILES += vendor/colt/prebuilt/common/media/1080x2340.zip:system/media/bootanimation.zip
...
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1440x2960)
     PRODUCT_COPY_FILES += vendor/colt/prebuilt/common/media/1440x2960.zip:system/media/bootanimation.zip
