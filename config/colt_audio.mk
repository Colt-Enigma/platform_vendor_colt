...
ALARM_PATH := vendor/colt/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/colt/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/colt/prebuilt/common/media/audio/ringtones
